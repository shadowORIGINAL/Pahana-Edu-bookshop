        ...
        <div class="content-area">
            ...
            <div class="dashboard-grid">
                <div class="dashboard-card">
                    ...
                    <p class="card-description">
                        Add, edit, and manage your team members. Control access permissions and monitor staff activity across your bookshop.
                    </p>
                    <a href="manage_staff.jsp" class="card-button">
                        🛠️ Manage Staff
                    </a>
                </div>
            ...
            <div class="quick-actions">
                ...
                <div class="action-buttons">
                    <a href="add_staff.jsp" class="action-btn">➕ Add New Staff</a>
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.ctrlKey || e.metaKey) {
                switch(e.key) {
                    case '1':
                        e.preventDefault();
                        window.location.href = 'manage_staff.jsp';
                        break;
                    case '2':
                        e.preventDefault();
