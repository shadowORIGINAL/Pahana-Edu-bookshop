            ...
            <div class="profile-container">
                ...
                <form action="ProfileServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="<%= user.getEmail() %>" required readonly class="readonly-field">
                    </div>
                    
                    <div class="form-group">
                        <label for="firstName">First Name:</label>
                        <input type="text" id="firstName" name="first_name" value="<%= user.getFirstName() %>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="lastName">Last Name:</label>
                        <input type="text" id="lastName" name="last_name" value="<%= user.getLastName() %>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="telephone" name="telephone" value="<%= user.getTelephone() != null ? user.getTelephone() : "" %>">
                    </div>
                    
                    <% if ("CUSTOMER".equals(user.getRole())) { %>
                        <div class="form-group">
                            <label for="unitsConsumed">Units Consumed:</label>
                            <input type="number" id="unitsConsumed" name="units_consumed" 
                                   value="<%= user.getUnitsConsumed() %>" min="0"
