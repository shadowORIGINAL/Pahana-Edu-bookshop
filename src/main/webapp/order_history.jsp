...
<body>
        ...
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">
                    View and manage all your previous orders with Pahana Edu
                </p>
            </div>
            ...
            <% if (orders == null || orders.isEmpty()) { %>
                <div class="no-orders">
                    ...
                    <a href="store" class="btn btn-primary">🛍️ Start Shopping</a>
                </div>
            <% } else { %>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const buttons = document.querySelectorAll('.btn, .action-btn, .back-btn');
        ...
        document.querySelectorAll('.order-table, .no-orders').forEach(el => {
            el.style.opacity = '0';
